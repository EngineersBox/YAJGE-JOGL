package com.engineersbox.yajgejogl.scene.element.object.md5.anim;

import com.engineersbox.yajgejogl.resources.loader.ResourceLoader;
import com.engineersbox.yajgejogl.scene.element.object.md5.bound.MD5BoundInfo;
...
import com.engineersbox.yajgejogl.scene.element.object.md5.hierarchy.MD5Hierarchy;
...
public class MD5AnimModel {
    ...
    public static MD5AnimModel parse(final String animFile) {
        final List<String> lines = ResourceLoader.loadResourceAsStringLines(animFile);
