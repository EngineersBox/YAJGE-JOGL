package com.engineersbox.yajgejogl.scene.element.object.md5.model;

import com.engineersbox.yajgejogl.resources.loader.ResourceLoader;
import com.engineersbox.yajgejogl.scene.element.object.md5.joint.MD5JointInfo;
...
public class MD5Model {
    ...
    public static MD5Model parse(final String meshModelFile) {
        final List<String> lines = ResourceLoader.loadResourceAsStringLines(meshModelFile);
