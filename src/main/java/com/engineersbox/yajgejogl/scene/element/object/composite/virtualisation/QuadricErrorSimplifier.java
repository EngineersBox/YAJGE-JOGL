...
import com.engineersbox.yajgejogl.scene.element.object.composite.virtualisation.primitive.Ref;
import com.engineersbox.yajgejogl.scene.element.object.composite.virtualisation.primitive.SymetricMatrix;
import com.engineersbox.yajgejogl.scene.element.object.composite.virtualisation.primitive.Triangle;
import com.engineersbox.yajgejogl.scene.element.object.composite.virtualisation.primitive.Vertex;
...
public class QuadricErrorSimplifier {
     ...
     */
    public Mesh simplify(final GL2 gl,
    ...
    public Mesh simplify(final GL2 gl,
        ...
        return createSimplifiedMesh(gl, complexNormals);
    }
    ...
    private Mesh createSimplifiedMesh(final GL2 gl,
                                      final boolean complexNormals) {
